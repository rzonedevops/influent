      ...
      transitionByIntent: function(intent, isIntermediate) {
        ...
        try {
          ...
          if (handlerInfosEqual(newState.handlerInfos, oldState.handlerInfos)) {
            ...
            if (!queryParamChangelist) {
              // Influent specific routing: The handlers changed but the query did not. Force a new query anyway
              oldState.queryParams = "";
              queryParamChangelist = getChangelist(oldState.queryParams, newState.queryParams);
            }
          }

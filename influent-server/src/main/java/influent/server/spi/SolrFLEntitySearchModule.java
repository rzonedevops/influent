...
public class SolrFLEntitySearchModule extends AbstractModule {

	@Override
	protected void configure() {
		bind(FL_EntitySearch.class).to(SolrEntitySearch.class);
	}
	 ...
	 */
	@Provides @Singleton
	public SolrEntitySearch connect (
		...
		try {
			return new SolrEntitySearch(config, connectionPool, namespaceHandler, sqlBuilder);
		} catch (Exception e) {

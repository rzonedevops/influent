package influent.midtier.api.rest.client;
...
public class RestPatternSearch extends RestClient implements FL_PatternSearch {
//	private static Logger logger = Logger.getLogger(RestPatternSearch.class);
	
	private static final Schema LONG_SCHEMA = Schema.create(Schema.Type.LONG);
	
	public RestPatternSearch(String url) {
		super(url);
	}
